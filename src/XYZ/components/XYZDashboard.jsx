  ...
  return (
    <div className="p-container">
      <div className="top special">
        <div className="a-title">XYZ Dashboard</div>
        ...
        <div className="d-bottom-half-bottom">
          <div className="d-manage-options">
            <div className="d-half-manage-options">
              ...
              >
                <div className="d-box">
                  <img src={UnPack} className="d-box-image" />
                  <div className="d-box-detail">
                    <div className="d-box-text">Unscaled Packages</div>
                    <div className="d-box-extra-text">Total Packages: 4</div>
                  </div>
                </div>
              </a>
              <a
              ...
              >
                <div className="d-box">
                  <img src={RePack} className="d-box-image" />
                  <div className="d-box-detail">
                    <div className="d-box-text">Rescaled Packages</div>
                    <div className="d-box-extra-text">Total Packages: 0</div>
                  </div>
                </div>
              </a>
            </div>
            <div className="d-half-manage-options">
              ...
              >
                <div className="d-box long">
                  ...
                  <div className="d-box-detail long">
