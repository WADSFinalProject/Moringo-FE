...
const CentraDeliveries = () => {
  const [undeliveredBatches, setUndeliveredBatches] = useState([
    { date: "01/01/24", time: "13:00", batchId: "#PL001", weight: 2.0 },
    { date: "01/01/24", time: "14:00", batchId: "#PL002", weight: 5.5 },
    { date: "01/01/24", time: "14:30", batchId: "#PL003", weight: 2.5 },
    { date: "01/01/24", time: "15:00", batchId: "#PL004", weight: 3.2 },
    { date: "02/01/24", time: "13:00", batchId: "#PL005", weight: 2.0 },
    { date: "02/01/24", time: "14:00", batchId: "#PL006", weight: 5.5 },
    { date: "02/01/24", time: "14:30", batchId: "#PL007", weight: 2.5 },
    { date: "02/01/24", time: "15:00", batchId: "#PL008", weight: 3.2 },
  ]);
  ...
  const filteredBatches = undeliveredBatches.filter((batch) =>
  ...
  const addNewShipment = () => {
    ...
    const newShipment = {
      shipmentId: "testid",
      weight: selectedBatchWeight,
      sender: deliveryDetailsSenderAddress,
      receiver: deliveryDetailsReceiverAddress,
      packageCount: deliveryDetailsPackageCount,
      expeditionTeam: deliveryDetailsExpeditionTeam,
      productionDate: deliveryDetailsDateValue,
      barcode: "https://pbs.twimg.com/media/FaWyeGBaAAAhhV-.jpg",
    };

    setOngoingShipments([...ongoingShipments, newShipment]);
    setUndeliveredBatches(
      undeliveredBatches.filter((batch) => batch.batchId !== selectedBatchId)
    );

    setSelectedBatchId("");
    setSelectedBatchWeight("");
    setDeliveryDetailsDateValue(null);
    setDeliveryDetailsSenderAddress("");
    setDeliveryDetailsReceiverAddress("");
    setDeliveryDetailsPackageCount("");
    setDeliveryDetailsExpeditionTeam("");
    setAddDeliveryDetailsOpen(false);
  };
          ...
          <div className="centra-top-section">
            ...
            <div className="centra-top-row">
              ...
              <h3 className="leaves-title">
                {selectedTab == 3 ? "Shipping Details" : "Deliveries"}
              </h3>
              {selectedTab == 3 ? null : (
